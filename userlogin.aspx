<%@ Page Title="" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="userlogin.aspx.cs" Inherits="login_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" Runat="Server">
    ...
    <script type="text/javascript" async="" src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/ec.js"></script><script id="facebook-jssdk" src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/sdk.js"></script><script async="" src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/fbevents.js"></script><script async="" src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/analytics.js"></script><script>    
...
<asp:Content ID="Content3" ContentPlaceHolderID="Gallery" Runat="Server">
    <h3 runat="server" id="h3" style="direction:rtl;text-align:center;color:forestgreen;visibility:hidden">حساب كاربري شما فعال گردديد.هم اكنون مي توانيد وارد شويد.</h3>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="Content" Runat="Server">
    <section class="center user-wrap f12 user-operation " style="direction:rtl;">
        <h1 class="f-dp-m f20">ورود كاربران</h1>
        <div style="text-align:center"><asp:Label ID="lblEror" runat="server" ForeColor="Red"></asp:Label></div>
        <div class="com-group-input rel mt30">
            <div class="label" style="font-size:larger">پست الكترونيك</div>
            <input runat="server" type="email" spellcheck="false" class="input f14" placeholder="پست الكترونيك" id="email" />&nbsp;<div class="warning tr hide abs">Wrong Email</div>
        </div>
        <div class="com-group-input rel mt30">
            <div class="label" style="font-size:larger">رمزعبور</div>
            <input runat="server" type="password" spellcheck="false" class="input f14" placeholder="رمز عبور" id="password" />
            <div class="warning tr hide abs">Wrong password</div>
        </div>
        <div class="clear user-act">
            <label class="fl">
                <input runat="server" type="checkbox" spellcheck="false" class="js-remember-me ver-middle mr5" checked="checked" /> مرا به خاطر بسپار  
            </label>
            <a href="#" class="underline fr">رمز عبور خود را فراموش كرده ام!</a>
        </div>
        <asp:Button ID="login" runat="server" Text="ورود" CssClass="btn btn-confirm js-login" OnClick="login_Click" Width="100%"></asp:Button>
        <p >ايجاد حساب كاربري</p>
        <a href="/register/register.aspx" class="btn btn-default">ثبت نام</a>
    </section>
    <div class="propDiv" style="display: none;">
        <div class="em_bg"></div>
        <div class="cenDv">
            <h1>We’ll Need Your Email</h1>
            <div class="em_tip">
                To allow us send you order status updates, community notifications and more.
            </div>
            <div class="com-group-input rel mt30 em_input">
                <input type="email" spellcheck="false" class="input f14" placeholder="Email address" id="inEmail"/>
                <div class="warning tr hide emailError">Wrong Email</div>
            </div>
            <a id="update">Confirm Email Address</a>
            <a class="emtip">Skip For Now</a>
        </div>
    </div>
    <!--plugin-->
    <script type="text/jscript"  src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/jquery-1.11.3.min.js"></script>
    <script type="text/jscript"  src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/md5.js"></script>
    <script type="text/jscript"  src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/login_and_register.js"></script>
    <script type="text/jscript" >
        $(function () {
            UserStatusExecution.login();
            /*$.cookie('name','vaan')
            console.log('获取的cookie是：'+$.cookie('user-login'));*/
        })
    </script>

    <div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/LJ9CfGDsgQ7.html" style="border: none;"></iframe></div></div><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div></div></div></div>
</asp:Content>
