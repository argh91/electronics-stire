<%@ Page Title="" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="regconf.aspx.cs" Inherits="register_regconf" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" Runat="Server">
    <section class="center user-wrap f12 user-operation " style="direction:rtl;">
        <h1 class="f-dp-m f20">تكميل ثبت نام </h1>
    ...
    <script type="text/jscript"  src="./login in_seeed Shop,Boost ideas,Extend the Reach_files/public_module.js"></script>
